...
class TopicVC:UIViewController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, FloatingActionViewDelegate {
    ...
    func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        ...
        if data.imageurl.count == 0 {
            ...
            return TopicImageCollectionViewCell.SIZE + 180
        }
    }
...
class TopicTableViewCell:UITableViewCell {
    ...
    func initialize() {
        ...
        imageCollectionView.snp_makeConstraints { (make) -> Void in
            ...
            make.height.greaterThanOrEqualTo(TopicImageCollectionViewCell.SIZE+20).priorityLow()
            make.left.equalTo(contentView.snp_leftMargin)
            make.right.equalTo(contentView.snp_rightMargin)
        }
...
extension TopicImageCollectionViewController:UICollectionViewDataSource, UICollectionViewDelegate {
